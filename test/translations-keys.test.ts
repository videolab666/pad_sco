...
const KNOWN_MISSING = new Set<string>([
  ...
  // app/vmix-settings/[id]/page.tsx — keys absent from the vmixSettings section
  "vmixSettings.countryGradientEndColor",
  "vmixSettings.countryGradientStartColor",
  "vmixSettings.courtPageActions",
  "vmixSettings.extraLarge",
  "vmixSettings.importantMomentIndicator",
  "vmixSettings.nameGradientEndColor",
  "vmixSettings.nameGradientStartColor",
  "vmixSettings.scoreGradientEndColor",
  "vmixSettings.scoreGradientStartColor",
  "vmixSettings.servingIndicatorBgColor",
  "vmixSettings.servingIndicatorBlock",
  "vmixSettings.servingIndicatorColor",
  "vmixSettings.servingIndicatorExample",
  "vmixSettings.servingIndicatorGradientEndColor",
  "vmixSettings.servingIndicatorGradientStartColor",
  "vmixSettings.setScoreBgColor",
  "vmixSettings.setScoreBlock",
  "vmixSettings.setScoreGradientEndColor",
  "vmixSettings.setScoreGradientStartColor",
  "vmixSettings.setScoreTextColor",
  "vmixSettings.showCountries",
  "vmixSettings.showCurrentPoints",
  "vmixSettings.showPlayerNames",
  "vmixSettings.showServingPlayer",
  "vmixSettings.showSetScore",
  "vmixSettings.usageInstructions",
  "vmixSettings.useGradientForScore",
  "vmixSettings.useGradientForServingIndicator",
  "vmixSettings.useGradientForSetScore",
  "vmixSettings.usingInTitleDesigner",
])
